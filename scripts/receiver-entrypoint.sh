...
while true; do
    ...
    ffmpeg -avoid_negative_ts make_zero -fflags '+genpts' -i 'udp://0.0.0.0:1234?timeout=0&buffer_size=6291456' -c copy -copyts -vsync passthrough -async 1 -f flv rtmp://rtmp-server:1935/live/stream
